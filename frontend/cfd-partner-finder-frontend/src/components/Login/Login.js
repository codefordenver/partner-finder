...
const Login = () => {
  ...
  return (
    <Box direction="row" justify="center" align="center" height="100%">
      <Box border="true" border-radius="10px" pad="large">
        {loginFailed && (
          <Notification
            status="error"
            size="medium"
        ...
        <Form
          onSubmit={({ value }) => loginUser(value.username, value.password)}
        >
