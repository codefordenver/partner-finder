		...
		<div id="home">
			<Header>
				...
				<Typography className={classes.logo} variant="h4" component="h1">
					<a className={classes.link} href="https://codefordenver.org/" target="_blank">
						Code For Denver
					</a>
				</Typography>
				...
				<Search debounceTime={DEBOUNCE_TIME_MS} onDebounce={(event) => setSearch(event.target.value)} />
			</Header>
			<Box marginX="15px">
				{/* // TODO: there must be a cleaner way to get the margins */}
				{/* Row containing "Add New" button and pagination controls */}
				<Box paddingY="30px" display="flex" flexDirection="row" justifyContent="flex-end" alignItems="center">
